...
<html>
<head>
<title>Product Search results using a form - t_search_price_supp_range_dol.php</title>
...
?>
  ...
  <p align="center"> 
 	  <input name="SUBMIT" type=SUBMIT onSelect="document.fcrit1.pForm_Name.value='t_search_price_supp_range_eur_c.php'" onClick="document.fcrit1.pForm_Name.value='t_search_price_supp_range_eur_c.php'"  value='Submit'> 
    &nbsp; </p>  
  <p>
    <input name="pForm_Name" type="hidden"  value="t_search_price_supp_range_eur_c.php">
</p>
</form>
<p>&nbsp;</p>
</body>
