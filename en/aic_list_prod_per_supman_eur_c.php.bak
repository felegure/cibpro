...
$previous_menu="t_search_supman_eur_c.php";
$CUR='€';
...
<html>
<head>
<title>Report List of product per supplier per manufacturer - aic_list_prod_per_supman_eur_c.php</title>
...
<table width="963" border="1" cellpadding="2" cellspacing="2">
  <tr>
    <th width="126" scope="row"><div align="center"><span class="Style1"><a href="t_search_supman_eur_c.php" title="Retour" class="Style7 Style6 "><span class="Style3"><span class="Style25">Back</span></span></a></span></div></th>
...
<table width=100%"  border="1" cellspacing="1" cellpadding="1">
  ...
  <tr class="Style30">
    ...
    <th width="7%" scope="col"><p class="Style5">Unit price (smallest unit)</p>    </th>
	  <th width="7%" scope="col"><p class="Style5">Date of bid opening / Date of reception</p>
  ...
  <tr class="Style30">
    ...
    <td nowrap><div align="center" class="Style5"><?php echo $row_ReSupplier['tproduct_desc']; ?></div></td>
    ...
    <td class="Style5"><div align="center"><?php echo $row_ReSupplier['tbuying_price_per_pack_eur'].$CUR; ?></div></td>
   
    <td><div align="center"><span class="Style5"><?php echo $row_ReSupplier['tbuying_qty_pack']; ?></span></div></td>
 
    <td><div align="center"><span class="Style5"><?php echo $row_ReSupplier['tbuying_tcost_eur'].$CUR; ?></span></div></td>
    <td><div align="center" class="Style5"><?php echo $row_ReSupplier['tinco_desc']; ?></div></td>
   
    <td><div align="center" class="Style5"><?php echo $row_ReSupplier['tbuying_ppu_eur'].$CUR; ?></div></td>
    <td nowrap><div align="center"><span class="Style5"><?php echo $row_ReSupplier['tbuying_dbid']; ?></span></div></td>
