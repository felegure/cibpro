...
mysqli_select_db($database_cibproto, $cibproto);
$query_Re_product = "SELECT * FROM tproduct";
...
<body>
<p align="center" class="Style1">List of Products  
 <?
$today = date (" m/j/Y");
echo " - date : ". $today." ";
?>
</p>
<p><a href="pickaform.php" title="Retour" class="Style7 Style6 "><span class="Style13"><span class="Style14">Back</span></span></a>
<div align="center">
