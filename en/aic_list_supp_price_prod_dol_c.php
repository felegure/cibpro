...
require_once ("aic_sel_parameters.php");
$previous_menu="t_search_price_supp_range_dol.php";
if ( $pCure =='EUR') {
$TCUR_SYMB = "€";
...
<table width="963" border="1" cellpadding="2" cellspacing="2">
  <tr>
    <th width="126" scope="row"><div align="center" class="Style25"><a href="t_search_price_supp_range_dol.php" title="Retour" class="Style7 Style6 "><span class="Style88">Back</span></a></div></th>
