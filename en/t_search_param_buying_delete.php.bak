...
<FORM NAME="fcrit1" ACTION="aic_form_buying_delete.php" METHOD=POST>
...
do {  
?>
            <option value="<?php echo $row_Re_categ['tcateg_id']?>"><?php echo $row_Re_categ['tcateg_id']?></option>
            <?php
...
&nbsp;
        <p>To
            <input name="pMaxi" type="text" value="99999">
      </td>
  </tr>
  <tr>
    <td>Currency</td>
...
?>
  ...
  <tr>
    ...
    <td><p>From&nbsp;
        ...
        <p> &nbsp; To &nbsp;&nbsp;
            <input name="pDend" type="text" value="31-12-2008" size="10" maxlength="10">
      </p></td>
  </tr>
    </table>
    <p align="center"> 
