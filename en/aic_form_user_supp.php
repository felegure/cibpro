...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  ...
  mysqli_select_db($database_conproto, $conproto);
  $Result1 = mysqli_query($updateSQL, $conproto) or die(mysqli_error());
...
$Re_users = mysqli_query($query_limit_Re_users, $conproto) or die(mysqli_error());
...
<form method="post" name="form2" action="<?php echo $editFormAction; ?>">
  <p><a href="manage_form.htm" title="Retour">Retour</a>	</p>
  <p align="center"> UPDATE USERS	</p>
  <p align="center">
