...
tsmalunit_desc, tpack_desc, tsrcfund_desc, tprov_coun_desc, tbuying_tcost, tbuying_qu, tprov_desc, tcur_desc, tcur_symb,
ttype_prov_desc,tinco_desc,ttransport_desc, tbuying_dbid
from $view_table_name_en
ORDER BY tproduct_desc ,  tbuying_ppu ";
/*
$query_RePriceLow = "SELECT tecowas_desc, tproduct_id,tproduct_desc, tbuying_uv, tconcent_desc, tdosage_desc, tpresent_desc, tbuying_ppu ,
...
<table width="100%"  border="1" cellspacing="1" cellpadding="1" summary="Lowest Price per period">
  <tr>
    ...
    <th width="2%" class="Style9" scope="col">Price per Unit</th>
  ...
  <tr>
    ...
    <td><div align="center" class="Style21"><?php echo $row_RePriceLow['tbuying_ppu'].$row_RePriceLow['tcur_symb']; ?></div></td>
