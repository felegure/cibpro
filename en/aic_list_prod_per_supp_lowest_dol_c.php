...
$previous_menu="t_search_price_range_dol_c.php";
?>

<Head>
<title>List of products by supplier with lowest prices -aic_list_prod_per_supp_lowest_dol_c.php</title>
...
<table width="963" border="1" cellpadding="2" cellspacing="2">
  <tr>
    <th width="126" scope="row"><div align="center"><span class="Style1"><a href="t_search_price_range_dol_c.php" title="Retour" class="Style7 Style6 "><span class="Style3"><span class="Style25 Style25">Back</span></span></a></span></div></th>
...
<table width="100%"  border="1" cellspacing="1" cellpadding="1" summary="Lowest Price per period">
  ...
  <tr>
    ...
    <td class="Style9 Style30"><div align="center"><span class="Style30"><?php echo $row_RePriceLow['tbuying_price_per_pack_dol'].$CUR; ?></span></div></td>
    <td nowrap class="Style9 Style30"><div align="center" class="Style30"><?php echo $row_RePriceLow['tbuying_qty_pack']; ?></div></td>
        <td class="Style9 Style30"><div align="center">
      <div align="center" class="Style30"><?php echo $row_RePriceLow['tbuying_tcost_dol'].$CUR; ?></div>
      <span class="Style16 Style31"></span></div></td>
	<td class="Style9 Style30"><div align="center">
      <div align="center" class="Style30"><?php echo $row_RePriceLow['tinco_desc']; ?></div>
      <span class="Style16 Style31"></span></div></td>
	  <td><div align="center" class="Style16 Style31"><?php echo $row_RePriceLow['tbuying_ppu_dol'].$CUR; ?></div></td> 
