...
tpack_id, tpack_desc, tbuying_qty_pack, tbuying_qu,
...
tbuying_tcost, tbuying_tcost_dol, tbuying_tcost_eur, 
...
$Re_buying_view_2 = mysqli_query($cibproto, $query_limit_Re_buying_view_2) or die(mysqli_error());
...
<table width="963" border="1" cellpadding="2" cellspacing="2">
  <tr>
    <th width="126" scope="row"><div align="center" class="Style73">&nbsp; <a href="manage_form_ins.php" title="Retour" class="Style9 Style19 Style76">Back</a></div></th>
    <td width="530"><div align="center" class="Style7 Style49"><span class="Style84"> 
        <span class="Style77"><strong>Modification</strong></span></span></div></td>
...
<table border="0" width="50%" align="center">
  <tr>
    ...
    <td width="23%" align="center">
      <?php if ($pageNum_Re_buying_view_2 < $totalPages_Re_buying_view_2) { // Show if not last page ?>
      <?php } // Show if not last page ?>
    <a href="<?php printf("%s?pageNum_Re_buying_view_2=%d%s", $currentPage, $totalPages_Re_buying_view_2, $queryString_Re_buying_view_2); ?>"><img src="Last.gif" border=0></a>    </td>
  </tr>
</table><table width="1000" border="1">
  <tr class="Style30">
  <th width="100" nowrap scope="row"><span class="Style75">Update   ? </span></th>
   <th width="100" nowrap scope="row"><span class="Style72">Date of bid Opening / Date of reception </span></th>
    <th width="100" nowrap scope="row"><span class="Style72">Product</span></th>
    <td width="185" class="Style1"><div align="center" class="Style30 Style73"><span class="Style72">Presentation</span></div></td>
    <td width="180" class="Style1"><div align="center" class="Style72"><span class="Style73">Packaging</span></div></td>

    <td width="180" class="Style30"><div align="center" class="Style73"><span class="Style72"><strong>Smallest unit</strong></span></div></td>
    <td width="162" class="Style1"><div align="center" class="Style72"><span class="Style30 Style73">Price per pack</span></div></td>
    <td width="177" class="Style1"><div align="center" class="Style73"><span class="Style30">Pack size</span></div></td>

<td width="164" class="Style1"><div align="center" class="Style72">Quantity</div></td>
    <td width="164" class="Style1"><div align="center" class="Style72">Total Cost</div></td>
    <td width="181" class="Style1"><div align="center" class="Style72">Inco term</div></td>
	 <td width="181" class="Style1"><div align="center" class="Style72">Smallest unit price</div></td>
	 <td width="181" class="Style1"><div align="center" class="Style72">Quantity (smallest unit price)</div></td> 
    <td width="163" class="Style1"><div align="center" class="Style73"><span class="Style30">Suppliers</span></div></td>
	 <td width="175" class="Style1"><div align="center" class="Style72">Type of Suppliers</div></td>
    <td width="175" class="Style1"><div align="center" class="Style72">Manufacturers</div></td>
    <td width="200" class="Style1"><div align="center" class="Style72">Supplied to</div></td>
  ...
  <tr>
	...
	//var_dump($row_Re_buying_view_2);
			
	echo "<A HREF='aic_form_buying_update_foreme.php?rowid=$rowid&hab=$row_Re_buying_view_2'>
			(Update ?) <A/>";		
    ...
    <td width="60" bgcolor="#CCCCCC" class="Style25"><div align="center" class="Style73"><span class="Style30 Style73"><span class="Style72"><?php echo $row_Re_buying_view_2['tpresent_desc']; ?></span></span></div></td>
    ...
    <td bgcolor="#CCCCCC" class="Style25"><div align="center" class="Style73"><span class="Style72"><?php echo $row_Re_buying_view_2['tsmalunit_desc']; ?></span></div></td>
    <td bgcolor="#CCCCCC" class="Style25"><div align="center" class="Style73"><div align="center" class="Style73"><?php echo $row_Re_buying_view_2['tbuying_price_per_pack'].$row_Re_buying_view_2['tcur_id']; ?></div></div></td>
    <td bgcolor="#CCCCCC" class="Style25"><div align="center" class="Style73"><?php echo $row_Re_buying_view_2['tbuying_pack_size']; ?></div></td>
    ...
    <td bgcolor="#CCCCCC" class="Style25"><div align="center" class="Style73"><?php echo $row_Re_buying_view_2['tinco_desc']; ?></div></td>
     <td bgcolor="#CCCCCC" class="Style25"><div align="center" class="Style73"><div align="center" class="Style73"><?php echo $row_Re_buying_view_2['tbuying_ppu'].$row_Re_buying_view_2['tcur_id']; ?></div></div></td>
       <td bgcolor="#CCCCCC" class="Style25"><div align="center" class="Style73"><?php echo $row_Re_buying_view_2['tbuying_qu']; ?></div></td>
    ...
    <td bgcolor="#CCCCCC" class="Style25"><div align="center" class="Style73"><?php echo $row_Re_buying_view_2['ttype_prov_desc']."<BR> ".$row_Re_buying_view_2['tprov_coun_desc']; ?></div></td>
 ...
 <td bgcolor="#CCCCCC" class="Style25"><div align="center" class="Style73"><?php echo $row_Re_buying_view_2['tecowas_desc']; ?></div></td>
...
// echo "XXXXXXXXXXXXXXXaic_form_buying_validateNew - validate_ligne validate_maj, rowid=$rowid, pays=$country <BR>";
 $updateSQL = sprintf("UPDATE $tbuying_table SET tbuying_status='2' 
 WHERE $tbuying_table.tbuying_rowid=$rowid and $tbuying_table.tbuying_ec_id = '{$country}' and 
