...
$query_Re_provider = "SELECT tprov_desc, tcountry_desc, tprov_cont, tprov_adr, tprov_postal, tprov_fax,tprov_tel1, tprov_tel2, 
tprov_email, tprov_website, tprov_remark FROM tprov_country_en_view order by tprov_desc where tprov_status = 1 order by tprov_desc ";
...
<table width="963" border="1" cellpadding="2" cellspacing="2">
  <tr>
    <th width="126" scope="row"><div align="center" class="Style85"><a href="pickareport_cons.php" title="Retour" class="Style25"><span class="Style86">Back</span></a></div></th>
...
<table width=100%"  border="1" cellspacing="2" cellpadding="2">
  ...
  <tr>
    ...
    <td><div align="center" class="Style5"><?php echo $row_Re_provider['tprov_desc']."<BR>".$row_Re_provider['tcountry_desc']; ?></div></td>
    ...
    <td><div align="center" class="Style5">
      <div align="center"><?php echo $row_Re_provider['tprov_fax']."<BR>". $row_Re_provider['tprov_tel1']."<BR>".$row_Re_provider['tprov_tel2']; ?></div>
    </div></td>
