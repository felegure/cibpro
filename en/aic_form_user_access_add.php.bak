...
$query_Re_Max_access = "SELECT max(taccess_id)  FROM taccess ";

$Re_Max_access = mysqli_query($query_Re_Max_access, $conproto) or die(mysqli_error());
$row_Re_Max_access = mysqli_fetch_assoc($Re_Max_access);
echo "Max_access= $Re_Max_access->taccess_id";
$totalRows_Re_Max_access = mysqli_num_rows($Re_Max_access);
