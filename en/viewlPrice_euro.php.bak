...
tbuying_ppu_eur, tsmalunit_desc, tpack_desc, tsrcfund_desc, tprov_coun_desc, tbuying_tcost, tbuying_qu, 
tprov_desc, tcur_desc, tcur_symb, ttype_prov_desc,tinco_desc,ttransport_desc, tbuying_dbid
from $view_table_name_en
ORDER BY tproduct_desc ,  tbuying_ppu_eur ";
/*
...
<table width="100%"  border="1" cellspacing="1" cellpadding="1" summary="Lowest Price per period">
  <tr>
    ...
    <th width="5%" nowrap scope="col"><span class="Style9">Price per Unit (Euro) </span></th>
  ...
  <tr>
	...
	<td><div align="center"><span class="Style21"><?php echo $row_RePriceLow['tbuying_ppu_eur']."€"; ?></span></div></td>
