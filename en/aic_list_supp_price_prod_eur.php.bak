...
$pMini = $_POST['pMini'] ;
$pMaxi = $_POST['pMaxi'] ;
$previous_menu="t_search_price_supp_range_eur.php";
// $cur_price="tbuying_ppu_eur";
// require_once("aic_prod_per_supplier.php");
...
<html>
<head>
<title>List of product  by price for each supplier - aic_list_supp_price_prod_eur.php</title>
...
<table width="963" border="1" cellpadding="2" cellspacing="2">
  <tr>
    <th width="126" scope="row"><div align="center" class="Style25"><a href="t_search_price_supp_range_eur.php" title="Retour" class="Style7 Style6 "><span class="Style88">Back</span></a></div></th>
...
tbuying_price_per_pack_dol, tbuying_price_per_pack_eur, tbuying_qty_pack, tbuying_tcost_dol, tbuying_tcost_eur, tinco_desc,
tbuying_ppu_dol,tbuying_ppu_eur,
  ...
  //  echo "Dans la boucle detail= $query_Redetsup <BR>"; 
	...
	// echo "totalRows_Redetsup=$totalRows_Redetsup <BR>";
	 ...
	 if ($totalRows_Redetsup < 1 ){
		...
		*/ 
		// require_once ("t_search_price_supp_range_dol_c.php");
		continue;
  		}
     ...
     <th width="5%" nowrap scope="col"><span class="Style30 Style60">Incoterm </span></th>
      ...
      <th width="5%" scope="col"><span class="Style30">Lead time (days)</span></th>
	    <th width="5%" scope="col"><span class="Style9 Style30">Comments</span></th>
              ...
              <td nowrap><div align="center"><span class="Style63"><?php echo $row_Redetsup['tbuying_price_per_pack_eur'].$CUR; ?></div></span></td>
              <td nowrap><div align="center"><span class="Style63"><?php echo $row_Redetsup['tbuying_qty_pack']; ?></div></span></td>
			  <td nowrap><div align="center"><span class="Style63"><?php echo $row_Redetsup['tbuying_tcost_eur'].$CUR; ?></div></span></td>
              <td nowrap><div align="center"><span class="Style63"><?php echo $row_Redetsup['tbuying_ppu_eur'].$CUR; ?></div></span></td>
