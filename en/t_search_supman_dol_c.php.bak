...
<div align="center">
<div align="left"><a href="pickareport_cons.php" title="Back">Back</a>
</div>
<FORM NAME="fcrit1" ACTION="aic_list_prod_per_supman.php" METHOD=POST>
...
?>
  ...
  <p align="center"> 
 	  <input name="SUBMIT" type=SUBMIT onSelect="document.fcrit1.pForm_Name.value='t_search_supman_dol_c.php'" onClick="document.fcrit1.pForm_Name.value='t_search_supman_dol_c.php'"  value='Submit'> 
    &nbsp; </p>  
  <p>
    <input name="pForm_Name" type="hidden"  value="t_search_supman_dol_c.php">
