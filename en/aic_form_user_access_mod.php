...
$Re_access = mysqli_query($query_limit_Re_access, $cibproto) or die(mysqli_error());
...
/*
mysqli_select_db($database_cibproto, $cibproto);
$query_Re_accesse = "SELECT * FROM taccess";
$Re_accesse = mysqli_query($query_Re_accesse, $cibproto) or die(mysqli_error());
$row_Re_accesse = mysqli_fetch_assoc($Re_accesse);
$totalRows_Re_accesse = mysqli_num_rows($Re_accesse);
*/
