...
<div align="center">
<div align="left"><a href="pickareport.php" title="Back"><font color="#990000">Back</font></a></div>
<FORM NAME="fcrit1" ACTION="aic_list_qual_probl.php" METHOD=POST>
...
<input name="pDend" readonly="readonly" type="text" value="31-12-2012" size="20" maxlength="10">
  ...
  <p align="center"> 
 	  <input name="SUBMIT" type=SUBMIT onSelect="document.fcrit1.pForm_Name.value='t_search_product_pb_qualite.php'" onClick="document.fcrit1.pForm_Name.value='t_search_product_pb_qualite.php'"  value='Send'> 
    &nbsp; </p>  
  <p>
    <input name="pForm_Name" type="hidden"  value="t_search_product_pb_qualite.php">
</p>
</form>
<p>&nbsp;</p>
</body>
