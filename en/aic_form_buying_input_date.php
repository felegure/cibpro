...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1"))
 {
/*
echo "XXXX  VAR_PAYS = $VAR_PAYS";
echo "XXXX VARPAYS= $VARPAYS";

echo "VALEUR DE POST VARPAYS";
 echo $_POST['VARPAYS'];
*/
if (ControleInsert($_POST)) 
{

// Il faut voir comment vider l'écran et rester avec un écran vide
/*
echo "tbuying_prov_id=";
echo $_POST['tbuying_prov_id'];
echo "<BR>";
echo "tbuying_manu_id=";
echo $_POST['tbuying_manu_id'];
*/
//
...
/*
echo "XXXXXXXXXXXVAR_PAYS_PROV= $VAR_PAYS_PROV<BR>";
echo "XXXXXXXXXXXXXXXXXXXpointeur->tprov_id=$pointeur_prov->tprov_id<BR>";
echo "XXXXXXXXXXXXXXXXXXpointeur->tcountry_desc=$pointeur_prov->tcountry_desc<BR>";
*/
...
/*
$Date_bid= "select STR_TO_DATE( $_POST['tbuying_dbid'], '%d-%m-%Y' ) from DUAL where 1";
$query_Date_dual = sprintf("%s LIMIT %d, %d", $query_Re_tempo_tbuying, $startRow_Re_tempo_tbuying, $maxRows_Re_tempo_tbuying); 
...
// echo " DDDDDDDDDDDDDDDdate_bid=$Date_bid";
 $insertSQL = sprintf("INSERT INTO tbuying_07
 (tbuying_ec_id, tbuying_product_id, tbuying_uv, 
...
?>
      ...
      <td>
        <select name="tbuying_present_id" class="Style19">
          <?php
do {  
?>
...
?>
    ...
    <tr valign="baseline">
      <td nowrap align="right" ><div align="center">Strenght</div></td>
      <td><input name="tbuying_uv" type="num" class="Style19" size="10">
      </td>
      <td align="right" nowrap><div align="center" class="Style22">Incoterm<span class="Style21">(*)</span></div></td>
      <td>
        <select name="tbuying_inco_id" class="Style19">
          <?php
do {  
?>
...
?>
      ...
      <td align="right" nowrap background="#990000"><div align="center"><span class="Style22">Date of bid<span class="Style21">(DD-MM-YYYY)(*)</span></span></div></td>
    ...
    <tr valign="baseline">
      ...
      <td>
        <select name="tbuying_categ_id" class="Style19">
          <?php
do {  
?>
...
?>
      ...
      <td><div align="center" class="Style22">Currency<span class="Style21">(*)</span></div></td>
      <td><div align="left">
        <select name="tbuying_cur_id" class="Style19">
          <?php
do {  
?>
...
<input name="tbuying_exr" type="text" class="Style19" size="8" value=<?php
    ...
    <tr valign="baseline">
      <td nowrap align="right"><div align="center" class="Style22">Dosage<span class="Style21">(*)</span></div></td>
      <td>
        <select name="tbuying_dosage_id" class="Style19">
          <?php
do {  
?>
...
?>
          ...
          <?php 
			echo $row_Re_provider['tprov_desc'].$Space.$row_Re_provider['tprov_coun_id'];
		     $VAR_PAYS=$row_Re_provider['tprov_coun_id'];
		// $pays = $_SESSION['VAR_PAYS'];
		// echo "xVAR_PAYS=$VAR_PAYS <BR>";
		// echo "pays=$pays <BR>";
		// $_POST['VAR_PAYS'] = $row_Re_provider['tprov_coun_id']; 
		// echo $_POST['VAR_PAYS']  ;
		// $_POST['tbuying_prov_coun_id'] = $row_Re_provider['tprov_coun_id'];
		
		 // echo $_POST['tbuying_prov_coun_id'];
		?>
          </option>
          <?php
...
?>
    ...
    <tr valign="baseline">
      ...
      <td>
        <select name="tbuying_pack_id" class="Style19">
          <?php
do {  
?>
...
?>
    ...
    <tr valign="baseline">
      ...
      <td><input name="tbuying_ppu" type="text" class="Style19" value="" size="32"></td>
...
?>
    ...
    <tr valign="baseline">
      ...
      <td><input name="tbuying_qu" type="text" class="Style19" value="" size="32"></td>
    ...
    <tr valign="baseline">
      ...
      <td><input name="tbuying_tcost" type="text" class="Style19" size="32" readonly="true"></td>
...
?>
    ...
    <tr valign="baseline">
      ...
      <td><input name="tbuying_pack_size" type="text" class="Style19" size="20"></td>
      <td><div align="left">Remark/Comments</div></td>
      <td><div align="left">
          <input name="tbuying_remark" type="text" class="Style19" value="" size="32">
      </div></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Price per pack </td>
      <td><input name="tbuying_price_per_pack" type="text" class="Style19" value="" size="10"></td>
      <td><div align="left"></div></td>
      <td><div align="left">
    ...
    <tr valign="baseline">
      ...
      <td><input name="tbuying_lead_time" type="text" class="Style19" value="" size="10"></td>
      <td><div align="left"></div></td>
      <td><div align="left">
    ...
    <tr valign="baseline">
      ...
      <td>
        <div align="center">
          <input name="submit" type="submit" class="Style1" value=" Insert ">
      </div></td>
      <td><div align="center"></div></td>
    </tr>
    <tr valign="baseline">
