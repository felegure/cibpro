...
{$tbuying_price_per_pack},tbuying_qty_pack, {$tbuying_tcost},  tinco_desc,min({$tbuying_ppu}) {$tbuying_ppu}, tbuying_qu,
...
if (isset($_GET['totalRows_RePriceLow'])) {
  ...
  $all_RePriceLow = mysqli_query($cibproto, $queryString_RePriceLow);
