...
//exécution de la requête et récupération du nombre de résultats
	...
	$result = mysqli_query($querym, $cibproto)or die(mysqli_error());;
	$affected_rows = mysqli_num_rows($result);
// S'il y a exactement un résultat, l'utilisateur est authentifié, sinon, on l'empêche d'entrer
	if($affected_rows == 1) {
...
// $QTY_PACK=$buying['tbuying_qty_pack2'];
	...
	$total_cost=$buying['tbuying_tcost2'];
	/*
	 echo "UPDATE FORM ppp=$ppp1, ppp2=$ppp2 , ppu1=$ppu1,  qu1=$qu1, qu2=$qu2, qty1=$qty1, qty2=$qty2, tcost=$total_cost<BR>";
 		echo "UPDATE FORM ppp=$ppp1, ppp2=$ppp2 , ppu1=$ppu1,  qu1=$qu1, qty1=$qty1, qty2=$qty2, tcost=$total_cost<BR>";

*///$PRICE_PER_PACK_TEMP=sprintf("%.4f",$_POST['tbuying_price_per_pack']);
//$PPP_TEMP=sprintf("%.4f",$_POST['tbuying_price_per_pack']);
/////////////////////////////
	if ( $_POST["tbuying_ok"]!= 0)
	{
	//$PPP_TEMP=sprintf("%.4f",$_POST['ppp2']);
...
// echo "Xvardbid=$vardbid <BR>";
 ...
 $vardbid2 = GetSQLValueString($_POST['tbuying_dbid2'] ,"date");
 	// echo "XXXXXXXXXXXXXXvardbid=$vardbid YYYYYYYYYY vardbid2=$vardbid2<BR>";
//if (empty($vardbid2))  
...
if ($vardbid2 != "NULL")
{
   ...
   //    echo " XXXXXXXXXXXXX jour=$jour, mois=$mois, annee=$annee";
...
//S'il y a exactement un résultat, l'utilisateur est authentifié, sinon, on l'empêche d'entrer
  ...
  //require_once ("t_search_param_buying_update.php");
   require_once ("aic_form_buying_update_form.php");
...
$Re_tempo_tbuying = mysqli_query($query_Re_tempo_tbuying, $cibproto) or die(mysqli_error());
...
$Re_tempo_tbuying = mysqli_query($query_limit_Re_tempo_tbuying, $cibproto) or die(mysqli_error()); 
$row_Re_tempo_tbuying = mysqli_fetch_assoc($Re_tempo_tbuying); 
if (isset($_GET['totalRows_Re_tempo_tbuying'])) { $totalRows_Re_tempo_tbuying = $_GET['totalRows_Re_tempo_tbuying'];
 } 
 else { $all_Re_tempo_tbuying = mysqli_query($query_Re_tempo_tbuying); 
...
?>
      ...
      <td width="391">
        ...
        <input name="tbuying_dbid2" type="text" class="Style19"  value="<?php echo $row_Re_tempo_tbuying['tbuying_dbid']; ?>"/>
...
<body>
  ...
  <p align="left"><a href="aic_form_buying_update.php" title="Retour" class="Style22">Retour</a>	
  <p align="center"> <span class="Style22">
  <?php
				echo "$Form_title_fr_update";
	?>
  </span></p>
  <p>
<table border="0" width="50%" align="center">
...
<form name="aic_form_input" method="post" action="<?php echo $editFormAction; ?>">
  <table width="48" height="10" border="1" align="center" cellpadding="1" cellspacing="1" bgcolor="#ECE9D8" frame="border"> 
    <tr valign="baseline"> 
      <td width="53" align="right" ><div align="center">Produit</div></td> 
      <td width="782"><div align="left">
        <input name="tproduct_desc22" type="text" class="Style19" value="<?php echo $row_Re_tempo_tbuying['tproduct_desc']; ?>" size="130" readonly="true">
      </div>
</td> 
  ...
  <table width="917" border="3" cellpadding="1" cellspacing="1" bgcolor="#ECE9D8">
    <tr valign="baseline">
      <td width="144" align="right" ><div align="center" class="Style26 Style20">
          <div align="right"><span class="Style22">Pr&eacute;sentation (*)</span></div>
      </div></td>
      <td width="185">
        <div align="left">
          <input name="tpresent_id2" type="text" class="Style68" value="<?php echo $row_Re_tempo_tbuying['tpresent_desc']; ?>" size="10" readonly="true">
...
?>
      ...
      <td width="170">
        <div align="center">
          <p class="Style29"><span class="Style22">Date d'ouverture des plis / Date r&eacute;ception <span class="Style68"> (DD-MM-YYYY) (*)</span></span></p>
      </div></td>
      <td width="391">
        <input name="tbuying_dbid" type="text" class="Style68" value="<?php echo $row_Re_tempo_tbuying['tbuying_dbid']; ?>" size="15" maxlength="10" readonly="true">
        <input name="tbuying_dbid2" type="text" class="Style19"  value="<?php echo $row_Re_tempo_tbuying['tbuying_dbid']; ?>" onChange="ControlFields(document.aic_form_input.tbuying_dbid2.value,'Date',1,document.aic_form_input.tbuying_dbid)">
        <a href="#"  onClick=" window.open('pop.php?frm=aic_form_input&ch=tbuying_dbid2','calendrier','width=350,height=160,scrollbars=0').focus();"><img src="petit_calendrier.gif" border="0"/></a> </td>
    </tr>
    <tr valign="baseline">
      <td height="43" align="right" nowrap ><div align="right"><span class="Style22">Plus petite unit&eacute; <span class="Style68">(*)</span></span></div></td>
      <td><div align="left">
          <table width="120" border="1" cellspacing="2" cellpadding="2">
            <tr>
              <th width="40" scope="row"><div align="left">
...
?>
      ...
      <td><div align="center" class="Style22">
          <div align="center" class="Style22">
            <div align="center">Source de financement <span class="Style68">(*)</span> </div>
          </div>
        </div>
      <td><div align="left">
          <table width="222" border="1" cellspacing="1" cellpadding="1">
...
?>
    ...
    <tr valign="baseline">
      <td align="right" nowrap><div align="center" class="Style22">
          <div align="right">Type de conditionement <span class="Style68">(*)</span></div>
      </div></td>
      <td>
        <div align="left">
          <table width="185" height="41" border="1" cellpadding="1" cellspacing="1">
...
?>
      ...
      <td align="right" nowrap><div align="center"  class="Style22">
          <div align="center">Fournisseur <span class="Style68">(*)</span></div>
      </div></td>
      <td>
        <div align="left">
          <table width="221" border="1" cellspacing="1" cellpadding="1">
...
?>
    ...
    <tr valign="baseline">
      <td align="right" nowrap><div align="center" class="Style22">
          <div align="right">Incoterme <span class="Style68">(*)</span></div>
      </div></td>
      <td><table width="185" border="1" cellspacing="1" cellpadding="1">
          <tr>
            <th width="115" scope="row"><div align="left">
...
?>
      ...
      <td align="right" nowrap><div align="center" class="Style29">
          <p align="center"><span class="Style22">Type de fournisseur <span class="Style68">(*)</span></span></p>
      </div></td>
      <td><div align="justify"> </div>
          <table width="221" border="1" cellspacing="2" cellpadding="2">
            <tr>
...
?>
    ...
    <tr valign="baseline">
      <td align="right" nowrap><div align="center" class="Style22">
          <p align="right">Devise <span class="Style68">(*)</span></p>
          <p>&nbsp;</p>
      </div></td>
      <td>
        <div align="left">
...
?>
          ...
          <span class="Style6"><span class="Style29"><span class="Style22"> </span></span></span></div></td>
      <td align="right" nowrap><div align="center" class="Style29">
          <div align="center"><span class="Style22">Fabricant <span class="Style68">(*)</span></span></div>
      </div></td>
      <td><div align="left">
          <table width="223" border="1" cellspacing="2" cellpadding="2">
            <tr>
...
?>
    ...
    <tr valign="baseline">
      <td align="right" nowrap><div align="center" class="Style22">
          <p align="right">Taux de change<span class="Style68">(*)</span></p>
      </div></td>
      <td>
        <div align="left"> <span class="Style6"><span class="Style29"><span class="Style22">
          <input name="exr" type="text" class="Style68" value="<?php echo $row_Re_tempo_tbuying['exr']; ?>" size="10" readonly="true">
          <input name="exr2" type="text" class="Style19" onChange="ControlFields(document.aic_form_input.exr2.value,'Taux de change ',1)" value="<?php echo $row_Re_tempo_tbuying['exr']; ?>" size="10">
      </span></span></span></div></td>
      <td><div align="center"><span class="Style22">Transport <span class="Style68">(*)</span></span></div></td>
      <td><div align="left">
          <table width="183" border="1" cellspacing="2" cellpadding="2">
            <tr>
              <th width="121" scope="row"><input name="ttransport_desc2" type="hidden" class="Style6" value="<?php echo $row_Re_transport['ttransport_desc']; ?>">
...
?>
    ...
    <tr valign="baseline">
      <td height="47" align="right" nowrap><div align="center">
          <p align="right" class="Style22">Prix unitaire de la plus petite unit&eacute;<span class="Style68">(*)</span></p>
          <p align="right" class="Style22">Quantit&eacute; de la plus petite unit&eacute;<span class="Style68">(*)</span> </p>
          <p class="Style22">
            <input type="radio" name="tbuying_price_unit"  class="Style19" value="1" checked>
            <span class="Style71">Saisie par la plus petite unit&eacute;</span></p>
      </div></td>
      <td><div align="center" class="Style22">
          <div align="left">
            <table width="181" border="0">
              <tr>
                <td width="175">                <input name="tbuying_ppu" type="text" class="Style68" value="<?php echo $row_Re_tempo_tbuying['tbuying_ppu'] ?>" size="8" 
					readonly="true">                <input name="tbuying_ppu2" type="text" class="Style190" onChange="ControlFields(document.aic_form_input.tbuying_ppu2.value,'Prix unitaire ',1,document.aic_form_input.tbuying_price_unit )"  
				   value="<?php echo $row_Re_tempo_tbuying['tbuying_ppu']; ?>" size="10">              </td>
              </tr>
              <tr>
                <td>                <div align="left">
			...
			readonly="true">
                    <input name="tbuying_qu2" type="text" class="Style190" value="<?php echo $row_Re_tempo_tbuying['tbuying_qu']; ?>" size="10"
				  onChange="
				  ControlFields(document.aic_form_input.tbuying_qu2.value,'Quantité ',1,document.aic_form_input.tbuying_price_unit);
          ...
          <p align="left" class="Style22">
            <input name="button23" type="hidden" class="Style19" onClick="CalculateTotalPrice(document.aic_form_input.tbuying_price_unit,1)"  value="Calculer">
            <span class="Style30">
            <input name="button2" type="button" class="Style22" onClick="ChoosePrice(document.aic_form_input.tbuying_price_unit)"  value="Changer">
          </span><span class="Style30"> </span> <span class="Style21"> </span></p>
      </div></td>
      <td>
        <p align="right" class="Style22"><span class="Style24">Remarques/Commentaires </span></p>
        <p align="right">&nbsp; </p></td>
      <td><div align="left">
          <p><span class="Style22">
            <input name="tbuying_remark" class="Style68"  value="<?php echo $row_Re_tempo_tbuying['tbuying_remark']; ?>" size="60"  readonly="true">
    ...
    <tr valign="baseline">
      <td height="47" align="right" nowrap><p class="Style22">Prix du conditionnement<span class="Style68">(*)</span></p>
          <p class="Style22"> Quantit&eacute;<span class="Style68">(*)</span></p>
          <p><span class="Style22">Taille du conditionnement<span class="Style68">(*)</span></span></p>
        <p><span class="Style22"><span class="Style24">
            <input type="radio" name="tbuying_price_unit"  class="Style19" value="1">
        </span></span><span class="Style71">Saisie par conditionnement </span> </p></td>
      <td>        <p align="left">
          <input name="tbuying_price_per_pack" type="text" class="Style68" value="<?php echo $row_Re_tempo_tbuying['tbuying_price_per_pack']; ?>" size="10" readonly="true">
          <input name="tbuying_price_per_pack2" type="text" class="Style19" onChange="ControlFields(document.aic_form_input.tbuying_price_per_pack2.value,'Prix du Conditionnement',1,document.aic_form_input.tbuying_price_unit)"value="<?php echo $row_Re_tempo_tbuying['tbuying_price_per_pack']; ?>" size="10">
          </p>        <p align="left">
            <input name="tbuying_qty_pack" type="text" class="Style68" value="<?php echo $row_Re_tempo_tbuying['tbuying_qty_pack']; ?>" size="10" readonly="true">
            <input name="tbuying_qty_pack2" type="text" class="Style19" onChange="ControlFields(document.aic_form_input.tbuying_qty_pack2.value,'Quantité ',1,document.aic_form_input.tbuying_price_unit)" value="<?php echo $row_Re_tempo_tbuying['tbuying_qty_pack']; ?>" size="10">
          </p>        <p align="left">
            <input name="tbuying_pack_size" type="text" class="Style68" value="<?php echo $row_Re_tempo_tbuying['tbuying_pack_size']; ?>" size="10" readonly="true">
            <input name="tbuying_pack_size2" type="text" class="Style19" onChange="ControlFields(document.aic_form_input.tbuying_pack_size2.value,'Taille du Conditionnement',1,document.aic_form_input.tbuying_price_unit)"  value="<?php echo $row_Re_tempo_tbuying['tbuying_pack_size']; ?>" size="10">
          </p>        <p align="left"><span class="Style22">
          <input name="button22" type="hidden" class="Style19" onClick="CalculateTotalPrice(document.aic_form_input.tbuying_price_unit,2)"  value="Calculer">
          <span class="Style69">
          <input name="button3" type="button" class="Style22" onClick="ChoosePrice(document.aic_form_input.tbuying_price_unit)"  value="Changer">
      </span></span> </p></td>
      <td><div align="center" class="Style22">
          <div align="right">
            <p><span class="Style6">.</span></p>
            <p><span class="Style70"><span class="Style24">Remarques/Commentaires </span></span></p>
            <p>&nbsp;</p>
            <p align="left">&nbsp;</p>
          </div>
      </div></td>
    ...
    <tr valign="baseline">
      ...
      <td><div align="left"><span class="Style22">Co&ucirc;t total
            <input name="tbuying_tcost2" type="text" class="Style19" value="<?php echo $row_Re_tempo_tbuying['tbuying_tcost']; ?>" size="10" readonly="true">
    ...
    <tr valign="baseline">
      <td align="right" nowrap><div align="center"><span class="Style21"><span class="Style24">D&eacute;lai de livraison (jours)</span> 
        </span></div></td>
      <td><div align="left"><span class="Style22">
        <input name="tbuying_lead_time" type="text" class="Style68" value="<?php echo $row_Re_tempo_tbuying['tbuying_lead_time']; ?>" size="10" readonly="true">
        <input name="tbuying_lead_time2" type="text" class="Style19" onChange="ControlFields(document.aic_form_input.tbuying_lead_time2.value,'D&eacute;lai de livraison ',1)"  value="<?php echo $row_Re_tempo_tbuying['tbuying_lead_time']; ?>" size="10">
    ...
    <tr valign="baseline">
      ...
      <td><div align="right"><span class="Style22">
      <input name="Submit" type="submit" class="Style1" onClick='ValidateON()' value="soumettre" >
</span></div></td>
      <td>
        <div align="right">
          <table width="224" border="1" cellpadding="1" cellspacing="1">
...
function ChoosePrice(radio) {
 ...
 //alert("Système 0= "+radio[i].value);
		...
		//  alert("tbuying_ok = "+document.aic_form_input.tbuying_ok.value);
			...
			//    alert ("3");
				// document.aic_form_input.tbuying_tcost2.value=document.aic_form_input.tbuying_qty_pack2.value * document.aic_form_input.tbuying_price_per_pack2.value;	
				// alert("Total Cost tcost= "+document.aic_form_input.tbuying_tcost.value);
			//	alert("Total Cost tcost2= "+document.aic_form_input.tbuying_tcost2.value);
			//		alert("qty_pack2= "+document.aic_form_input.tbuying_qty_pack2.value);
				// alert ("PPP="+PPP);
				 ...
				 //    document.aic_form_input.tbuying_qu2.disabled=true;
					...
					//alert("3 qty_pack2= "+document.aic_form_input.tbuying_qty_pack2.value);
				
					 //alert("4 Total Cost PPU2= "+document.aic_form_input.tbuying_tcost2.value);
					// alert("qty_pack= "+document.aic_form_input.tbuying_qty_pack.value);
					// alert(" = "+document.aic_form_input.tbuying_ppp.value);
					//alert("5 qu2= "+document.aic_form_input.tbuying_qu2.value);
...
{
 var m="mon texte"; 
	var confirmation=confirm("Confirm the modification?"); 
	//alert ("validateOn");
	
	// je dois tester les valeurs des dates !
	date1=document.aic_form_input.tbuying_dbid.value;
	date2=document.aic_form_input.tbuying_dbid2.value;
	// alert (date1+'date1');
	// alert (date2+'date2');
	if (date1 != date2) ok=1;
	else ok=document.aic_form_input.tbuying_ok.value;
	// alert ("ValidateOn ok="+ok);
	if (confirmation){ 
  //action à faire pour la valeur true 
  //	alert ("then confirmation");
...
function ControlFields(champ,nomchamp,ordre, bouton)
{
   ...
   // alert ("ControlFields ordre="+ordre);
	if(champ=='') // 1
	{
		alert(nomchamp+' est un champ Obligatoire !');
		//document.aic_form_input.champnom.focus();
	}
	else if(isNaN(champ)) // 2
	{
	 ...
	 if (nomchamp!='Date') {
		alert(nomchamp+' est un champ Numérique !');
		document.aic_form_input.tbuying_ok.value=0;
		}
		else { 
				//alert ('date');
