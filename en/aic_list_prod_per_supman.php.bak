...
<table width=100%"  border="1" cellspacing="1" cellpadding="1">
  ...
  <tr class="Style30">
    ...
    <td><div align="center" class="Style5"><?php echo number_format($row_ReSupplier['tbuying_pack_size']); ?></div></td>

    <td class="Style5"><div align="center"><?php 
	                                       if ( $CUR=='$') {echo $CUR.number_format($row_ReSupplier[$tbuying_price_per_pack],4);}
	                                       else {echo number_format($row_ReSupplier[$tbuying_price_per_pack],4).$CUR;}
	                                       ?></div></td>
   
    <td><div align="center"><span class="Style5"><?php 
	//echo $row_ReSupplier['tbuying_qty_pack']; 
	echo number_format($row_ReSupplier['tbuying_qty_pack']);
    ?>
        </span></div></td>
 
    <td><div align="center"><span class="Style5"><?php 
	                                             if ( $CUR=='$') { echo $CUR.number_format($row_ReSupplier[$tbuying_tcost],4);}  
											     else {echo number_format($row_ReSupplier[$tbuying_tcost],4).$CUR;
												 }                                      
	                                            ?></span></div></td>
    <td><div align="center" class="Style5"><?php echo $row_ReSupplier['tinco_desc']; ?></div></td>
   
    <td><div align="center" class="Style5"><?php 
											if ( $CUR=='$') {echo $CUR.number_format($row_ReSupplier[$tbuying_ppu],4);}
	                                        else {echo number_format($row_ReSupplier[$tbuying_ppu],4).$CUR;} 
	                                        ?></div></td>
		
		<td nowrap class="Style9 Style30"><div align="center"><span class="Style16 Style31"><em><span class="Style30"><?php 
		echo number_format($row_ReSupplier['tbuying_qu']);
		?></span></em></span></div></td>
...
<?php // cas où on a qu'un sujet de débat
             if ($pCurrency=='$') {  ?>
<p align="center"><span class="Style87"><a href="export_excel_report.php?requete=<?PHP echo $query_ReSupplier ?>&choix=2 &cur='$'" class="Style6"><span class="Style62 Style6 Style25 Style54"><span class="Style62 Style6  Style25 Style89"><span class="Style22 Style50">Export to excel</span></span></span></a></span></p>
		  ...
		  <?php } else { ?>
            <p align="center"><span class="Style87"><a href="export_excel_report.php?requete=<?PHP echo $query_ReSupplier ?>&choix=2 &cur='E'" class="Style6"><span class="Style62 Style6 Style25 Style54"><span class="Style62 Style6  Style25 Style89"><span class="Style22 Style50">Export to excel</span></span></span></a></span></p>
          <?php } ?>
