...
tbuying_status
FROM $view_table_name_ent WHERE tecowas_id = '{$_SESSION['COUNTRY']}'
...
<table border="0" width="50%" align="center">
 ...
 <a href="radio_4.php">radio_4</a> <table width="1000" border="1">
  <tr>
  <th width="100" nowrap scope="row"><span class="Style30">Check</span></th>
  ...
  <tr>
    <td width="100" nowrap class="Style25"><div align="center">
      <input name="checker" type="checkbox" class="Style19" value=""  >
...
<form name="form1" method="post" action="validate_buyinge.php?param=1">
  <div align="center">
