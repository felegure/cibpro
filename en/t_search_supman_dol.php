...
?>
  ...
  <p align="center"> 
 	  <input name="SUBMIT" type=SUBMIT onSelect="document.fcrit1.pForm_Name.value='t_search_supman_dol.php'" onClick="document.fcrit1.pForm_Name.value='t_search_supman_dol.php'"  value='Submit'> 
    &nbsp; </p>  
  <p>
    <input name="pForm_Name" type="hidden"  value="t_search_supman_dol.php">
