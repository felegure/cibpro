...
<div align="center">
<div align="left"><a href="manage_form_val.php" title="Back">Back</a></div>
...
?>
  ...
  <tr>
    ...
    <td><p>From&nbsp;
      ...
      <p> &nbsp; To &nbsp;&nbsp;
            <input name="pDend" readonly="readonly" type="text" value="31-12-2011" size="20" maxlength="10">
    ...
    <p align="center"> 
 	  <input name="SUBMIT" type=SUBMIT onSelect="document.fcrit1.pForm_Name.value='t_search_param_control_val.php'" onClick="document.fcrit1.pForm_Name.value='t_search_param_buying_control_val.php'"  value='Submit'> 
    &nbsp; </p>  
  <p>
    <input name="pForm_Name" type="hidden"  value="t_search_param_buying_control_val.php">
  </p>
</form>
<p>&nbsp;</p>
</body>
