...
$ReManufacturer = mysqli_query($query_limit_ReManufacturer, $cibproto) or die(mysqli_error());
...
if (isset($_GET['totalRows_ReManufacturer'])) {
  ...
  $all_ReManufacturer = mysqli_query($query_ReManufacturer);
...
<html>
<head>
<title>Manufacturers List - aic_list_manuf_summary_c.php</title>
...
<table width="963" border="1" cellpadding="2" cellspacing="2">
  <tr>
    <th width="126" height="32" scope="row"><div align="center" class="Style9"><a href="pickareport_cons.php" title="Retour" class="Style7 Style6 "><span class="Style25 Style19">Back</span></a></div></th>
...
<table width=100%"  border="1" cellspacing="2" cellpadding="2">
  ...
  <tr class="Style30">
    ...
    <th width="5%" scope="col"><span class="Style5">Fax/telephone</span></th>
  ...
  <tr>
    ...
    <td><div align="center" class="Style5 Style30"><?php echo $row_ReManufacturer['tmanu_desc']."<BR>".$row_ReManufacturer['tcountry_desc']; ?></div></td>
    <td><div align="center" class="Style5 Style30"><?php echo $row_ReManufacturer['tmanu_cont']; ?></div></td>
    <td><div align="center" class="Style5 Style30"><?php echo $row_ReManufacturer['tmanu_adr']."<BR>". $row_ReManufacturer['tmanu_postal']; ?></div></td>
    <td><div align="center" class="Style5 Style30">
      <div align="center"><?php echo $row_ReManufacturer['tmanu_fax']."<BR>". $row_ReManufacturer['tmanu_tel1']."<BR>".$row_ReManufacturer['tmanu_tel2']; ?></div>
    </div></td>
