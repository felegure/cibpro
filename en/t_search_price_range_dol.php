...
?>
  ...
  <p align="center"> 
 	  ...
 	  <input name="SUBMIT" type="submit" onSelect="document.fcrit1.pForm_Name.value='t_search_price_range_dol.php'" onClick="document.fcrit1.pForm_Name.value='t_search_price_range_dol.php'"  value='Submit'> 
    &nbsp; </p>  
  <p>
    <input name="pForm_Name" type="hidden"  value="t_search_price_range_dol.php">
