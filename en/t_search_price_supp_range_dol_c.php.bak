...
$query_Re_ecowas = "SELECT tecowas_id, tecowas_desc FROM tecowas_en";
...
?>
  ...
  <p align="center"> 
 	  <input name="SUBMIT" type=SUBMIT onSelect="document.fcrit1.pForm_Name.value='t_search_price_supp_range_dol_c.php'" onClick="document.fcrit1.pForm_Name.value='t_search_price_supp_range_dol_c.php'"  value='Submit'> 
    &nbsp; </p>  
  <p>
    <input name="pForm_Name" type="hidden"  value="t_search_price_supp_range_dol_c.php">
